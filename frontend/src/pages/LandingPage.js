...
const LandingPage = () => {
    ...
    return ( <
        ...
        <
        div className = "icon" > 💬 < /div> <h3> Chat to Setup </h
        3 > { " " } <
        p >
        ...
        div className = "feature-card" >
        <
        div className = "icon" > 📸 < /div> <h3> Upload Products </h
        3 > { " " } <
        p >
        Snap a photo of your product, add a price, and it 's instantly
        live on your personalized web store. { " " } <
        /p>{" "} <
        /div> <
        div className = "feature-card" >
        <
        div className = "icon" > 🔗 < /div> <h3> Share Link </h
        3 > { " " } <
        p >
