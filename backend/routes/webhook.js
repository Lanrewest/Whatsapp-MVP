...
const prompts = {
    en: {
        ...
        askFeedback: "We value your input! Please type your feedback/suggestions for ArewaMarket below:",
        feedbackReceived: "🙏 Thank you! Your feedback has been recorded. Our team will look into it.",
        verifying: "Generating your secure payment link...",
        verifyError: "Payment system busy. Please try again or contact support.",
        askVerifyChoice: "How would you like to pay for your badge?\n1. Pay Online (Instant ✅)\n2. Bank Transfer (Manual 🏦)",
        bankDetails: "Please transfer ₦2,000 to:\n\n*Bank:* Zenith Bank\n*Account:* 1234567890\n*Name:* ArewaMarket\n\nAfter payment, please send a *screenshot of the receipt* here.",
        receiptReceived: "🙏 Thank you! Your receipt has been received. Our team will verify it and update your badge shortly.",
    ...
    ha: {
        ...
        askFeedback: "Muna daraja ra'ayin ku! Da fatan za a rubuta shawara ko korafi game da ArewaMarket a kasa:",
        ...
        askVerifyChoice: "Yaya kake son biya?\n1. Biya ta Online (Nan take ✅)\n2. Canja wurin kudi ta Banki (Manual 🏦)",
        bankDetails: "Da fatan za a tura ₦2,000 zuwa:\n\n*Bank:* Zenith Bank\n*Account:* 1234567890\n*Sunan:* ArewaMarket\n\nBayan kayi biya, turo hoton shaidar biyan ka (receipt) a nan.",
        receiptReceived: "🙏 Mun gode! Mun karbi hoton shaidar biyan ku. Za mu duba sannan mu inganta asusun ku nan ba da jimawa ba.",
            ...
            case "main_menu":
                if (msg === "1") {
                    ...
                    if (!process.env.PAYSTACK_SECRET_KEY) {
                        twiml.message(
                            "Automated verification via payment is currently being set up. Please contact support for manual verification!",
                        );
                        return res.type("text/xml").send(twiml.toString());
                    }
                ...
                if (mediaUrl) {
                    try {
                        ...
                        const uploadResult = await cloudinary.uploader.upload(
                            authenticatedMediaUrl, { folder: "arewamarket_receipts" },
                        );
