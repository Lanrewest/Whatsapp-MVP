...
const prompts = {
    en: {
        ...
        askFeedback: "We value your input! Please type your feedback/suggestions for Arewa Connect below:",
    ...
    ha: {
        ...
        askFeedback: "Muna daraja ra'ayin ku! Da fatan za a rubuta shawara ko korafi game da Arewa Connect a kasa:",
                ...
                if (mediaUrl) {
                    try {
                        ...
                        const uploadResult = await cloudinary.uploader.upload(
                            authenticatedMediaUrl, { folder: "arewaconnect_receipts" },
                        );
