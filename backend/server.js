        ...
        const augmentedProducts = allProds
            .map((p) => {
                ...
                return {
                    ...
                    traderName: trader && trader.companyName ?
                        trader.companyName : "Unknown Trader",
...
app.post("/api/request", async(req, res) => {
    ...
    try {
        ...
        if (err.code === 63038) {
            ...
            return res.status(429).json({ error: "Twilio daily limit exceeded. Please try again tomorrow." });
        }
